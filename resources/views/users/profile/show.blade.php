                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col items-center justify-center gap-10">
                            <div class="relative w-32 h-32">
                                ...
                                <label for="profile_image" class="absolute w-10 h-10 bottom-0 right-0 bg-blue-500 rounded-full pt-[.3em] text-center border-3 border-[#F9FAFB] cursor-pointer">
                            ...
                            <button type="submit"
                                class="w-full py-3 bg-[#3B82F6] text-[#F9FAFB] text-[14px] font-medium rounded-md hover:bg-[#1E40AF] transition duration-200"
                                style="font-family: 'Inter', sans-serif;">
                                Update
                            </button>
                        </div>
