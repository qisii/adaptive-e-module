    ...
    <div class="w-[85%] min-h-[80vh] flex my-4 mx-auto" id="home">
        ...
        <div class="w-1/2">
            <div class="flex flex-col h-full gap-4"> 
                ...
                <div class="flex flex-1 gap-4">
                    <div class="w-[60%] h-60">
                        <div class="w-80 h-full rounded-lg bg-cover ms-auto" style="background-image: url('{{ asset('assets/images/banner3.jpg') }}');"></div>
                    </div>
                    <div class="w-[40%] h-30">
                        <div class="w-50 h-full rounded-lg bg-cover" style="background-image: url('{{ asset('assets/images/banner4.jpg') }}');"></div>
                    </div>
                </div> 
            </div> 
        </div>
