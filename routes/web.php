...
Route::group(['prefix' => 'profile', 'as' => 'profile.'], function(){
    Route::get('/show', [ProfileController::class, 'show'])->name('show'); // add {id}
...
Route::group(['prefix' => 'comment-suggestion', 'as' => 'comment-suggestion.'], function(){
    Route::get('/', [CommentSuggestionController::class, 'index'])->name('index');
});
